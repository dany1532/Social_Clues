...
public class CombineChildrenMultiMaterial : MonoBehaviour
{
	
	[ContextMenu("Combine Multi-Material")]
	public void Combine ()
	{ 
		...
		foreach (MeshFilter meshFilter in meshFilters) {
			...
			for (int s = 0; s < meshFilter.sharedMesh.subMeshCount; s++) {
                ...
                {
                    if ((Material)materials[materialArrayIndex] == meshRenderer.sharedMaterials[s])
						break;
				}
