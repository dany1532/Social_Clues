...
public class UIViewport : MonoBehaviour
{
	...
	void LateUpdate ()
	{
		if (topLeft != null && bottomRight != null)
		{
			...
			//Debug.Log("Camera: " + (mCam.transform.position + new Vector3(mCam.rect.xMin, mCam.rect.yMin, 0)).ToString() + " to " + (mCam.transform.position + new Vector3(mCam.rect.xMax, mCam.rect.yMax, 0)).ToString());
		}
	}
